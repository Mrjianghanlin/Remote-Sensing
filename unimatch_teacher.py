...
parser.add_argument('--labeled-id-path', type=str, default="splits/cityscapes/1_8/labeled.txt")
parser.add_argument('--unlabeled-id-path', type=str, default="splits/cityscapes/1_8/unlabeled.txt")
parser.add_argument('--save-path', type=str, default="exp/cityscapes/unimatch/resnet50/un_1_8")
