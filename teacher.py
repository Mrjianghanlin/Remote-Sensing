...
parser.add_argument('--labeled-id-path', type=str, default="splits/pascal/VOC_17/labeled.txt")
parser.add_argument('--unlabeled-id-path', type=str, default="splits/pascal/VOC_17/unlabeled.txt")
parser.add_argument('--save-path', type=str, default="exp/supervised/Hrnet/teacher/VOCdevkit_17")
...
def main():
    ...
    cfg = {
        'dataset': 'pascal',
        'data_root': 'VOCdevkit/VOCdevkit_17/VOC2007',
        'nclass': 17,
        'crop_size': 256,
        'pretrained': True,
        'epochs': 200,
    ...
    for epoch in range(epoch + 1, cfg['epochs']):
        ...
        for i, (img, mask) in enumerate(trainloader):
            ...
            # 合并损失
            combined_loss = ce_loss + distill_loss
