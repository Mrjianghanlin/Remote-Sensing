...
from models.utils.utils import download_weights, show_config
...
if __name__ == "__main__":
    ...
    #   所使用的的主干网络：
    #   mobilenet
    #   xception hrnetv2_48 resnest50 resnext101_ibn_a resnext50_ibn_a
    #---------------------------------#
    backbone        = "resnet50"
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    from models.model import DeepV3Plus
