...
parser.add_argument('--labeled-id-path', type=str, default="splits/pascal/1_1/labeled.txt")
parser.add_argument('--unlabeled-id-path', type=str, default="splits/pascal/1_1/unlabeled.txt")
parser.add_argument('--save-path', type=str, default="exp/dali/unimatch/1_1_n")
